...
SNR = 4 ;    % dB (plus 24dB 16*16,30dB 32*32)
...
% end
% 
% save(['testing_noT_label_target_clutter_CNR20_20_H' ,num2str(H) ,'_SNR',num2str(SNR),'.mat'],'RD_map_label'); % for YOLO-CFAR label(target)
% save(['testing_trainDNN_softknee_clutter_CNR20_20_H' ,num2str(H) ,'_SNR',num2str(SNR),'.mat'],'RD_map_softknee'); % for DNN input
% save para H SNR N M;